...
class FollowersView extends StatelessWidget {
  ...
  const FollowersView({super.key, this.userId, this.userName});
  ...
  Widget build(BuildContext context) {
    ...
    final titleText = isOwnProfile
        ? 'Followers'
        : (userName != null ? '$userName\'s Followers' : 'Followers');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: cubit.getFollowersStream(targetUserId),
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
              child: Text(
                'Failed to load followers: ${snapshot.error}',
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'When people follow, they will appear here.',
  ...
  void _confirmRemoveFollower(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'ConnectHub won\'t notify this user that they were removed from your followers.',
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () async {
              Navigator.pop(ctx);
              try {
                await context.read<ProfileCubit>().removeFollower(followerId);
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: const Text('Follower removed.'),
...
class _FollowerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(
      future: cubit.getUserDoc(followerId),
      builder: (context, snapshot) {
